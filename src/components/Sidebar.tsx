...
import { Plus, ShieldAlert, X, ChevronRight, Home } from 'lucide-react';
      ...
      >
        ...
        <div style={{
          ...
          >
            ...
            <span className="navbar-badge">SIDEBAR</span>
          </div>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 12px' }}>
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            {/* Admin Quick Add Button inside sidebar */}
            {isAdmin && (
              <button
                onClick={() => {
                  onOpenNewPlatformModal();
              ...
              >
                ...
                <span>Add Sidebar Button / Page</span>
              </button>
            )}
          </div>
        ...
        {/* Footer Admin Switch - Only visible when Admin mode is active via /admin */}
        {isAdmin && (
          <div style={{
            padding: 16,
